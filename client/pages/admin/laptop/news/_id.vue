...
export default {
    async asyncData({$axios, params}){
        try {
            let News = await $axios.$post(LaptopAPI.admin.GetNewsByID, {
                _id: params.id
            });
    ...
    methods: {
        ...
        async EditInformation () {
            ...
            try {
                let News = await this.$axios.$post(LaptopAPI.admin.EditInformationNews, {
                    _id: this.News._id,
        ...
        async EditContent (content) {
            ...
            try {
                let News = await this.$axios.$post(LaptopAPI.admin.EditContentNews, {
                    _id: this.News._id,
                    content: content
                });
